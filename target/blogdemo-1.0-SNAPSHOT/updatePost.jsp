                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <form action="/Admin-post?action=updatePost&id=${post.id}" method="post"
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="disabled-input" name="id" value="${post.id}"
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="text-input" name="title" value="${post.title}"
                                                       class="form-control">
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <textarea name="shortContent" id="shortContent" rows="9"
                                                          class="form-control">${post.shortContent}</textarea>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <textarea name="fullContent" id="fullContent" rows="9"
                                                          placeholder="Content..."
                                                          class="form-control">${post.fullContent}</textarea>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="images" name="image" value="${post.image}"
                                                       class="form-control">
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <select class="form-control" name="category" required>
                                                    <c:forEach items="${categories}" var="categorys">
                                                        <c:if test="${categorys.id == post.getCategory().getId()}">
                                                            <option value="${categorys.id}"
                                                                    selected>${categorys.categoryName}</option>
                                                        </c:if>
                                                        <c:if test="${categorys.id != post.getCategory().getId()}">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9" >
                                                <input type="text"  id="myTags" data-role="tagsinput" class="form-control simple-tags" name="tags" value="${tagsString}">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-6">
                                            ...
                                            <div class="col-6">
                                                <button type="button" class="btn btn-dark btn-sm" style="margin-left: 350px">
