                                    ...
                                    <form action="/Admin-category?action=updateCategory&id=${category.id}" method="post"
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="disabled-input" name="id" value="${category.id}"
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <input type="text" id="text-input" name="name" value="${category.categoryName}"
                                                       class="form-control">
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <button type="button" class="btn btn-dark btn-sm" style="margin-left: 350px">
                                                    <a href="/Admin-category"><i class="fa fa-ban"></i>Back</a>
                                                </button>
                                            </div>
                                        </div>
                                    </form>
